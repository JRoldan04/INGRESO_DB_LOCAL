...
for SERVER, DATABASE, USUARIO, PASSWORD in servidores:
    try:
        ...
        if not data:
            ...
            existing_query = """
            SELECT RVCID, PCWSID, FCRID, FCRInvNumber, MicrosChkNum, InvoiceType, InvoiceLetter, FCRBsnzDate, FiscalRef, ItemIndex
            FROM "COLSUBSIDIO_HDI"."T_SIMP_CAPS_FCR_INVOICE_DETAIL_BP"
            """
            ...
            key_cols = ["RVCID", "PCWSID", "FCRID", "FCRInvNumber", "MicrosChkNum", 
                        "InvoiceType", "InvoiceLetter", "FCRBsnzDate", "FiscalRef", "ItemIndex"]
